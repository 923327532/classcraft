    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="w-16 bg-gray-800 shadow-lg flex flex-col items-center py-4 space-y-4">
            ...
            <nav class="flex flex-col space-y-2 w-full">
                ...
                {{-- Misiones (Activo en esta página) --}}
        ...
        {{-- Área Principal de la Vista de Misiones --}}
            ...
            <div class="relative z-10 h-full flex flex-col p-6">
                <div class="py-6">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="space-y-4">
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg p-6 text-center border border-gray-200">
                                <p class="text-gray-700 dark:text-gray-300 text-lg font-medium">
                                    Actualmente no hay misiones que puedas seguir.
                                </p>
                            </div>
                        </div>
                    </div>
