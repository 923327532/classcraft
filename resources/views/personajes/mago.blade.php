                            ...
                            <div class="role-card mt-8">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-blue-700 font-semibold text-xl">Provedor de energía y efectos especiales</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="character-selection-card">
                                ...
                                <div class="flex gap-8 justify-center">
                                    <div class="selectable-card warrior-card cursor-pointer text-center card-hover w-44"
                                        data-value="maga" tabindex="0" role="button" aria-pressed="false">
                                        <div class="relative mb-6">
                                            <img src="{{ asset('images/maga.png') }}" alt="Maga"
                                                class="h-28 w-28 object-contain mx-auto rounded-2xl shadow-lg bg-gradient-to-br from-purple-400 to-pink-500 p-4">
                                        </div>
                                        <p class="font-bold text-xl text-gray-800 mb-3">Maga</p>
                                        <div
                                            class="text-sm text-gray-600 bg-purple-100 rounded-full px-4 py-2 border border-purple-200">
                                            Sabia • Enigmática
                                        </div>
                                    </div>

                                    <div class="selectable-card warrior-card cursor-pointer text-center card-hover w-44"
                                        data-value="mago" tabindex="0" role="button" aria-pressed="false">
                                        <div class="relative mb-6">
                                            <img src="{{ asset('images/mago.png') }}" alt="Mago"
                                                class="h-28 w-28 object-contain mx-auto rounded-2xl shadow-lg bg-gradient-to-br from-indigo-400 to-blue-500 p-4">
                                        </div>
                                        <p class="font-bold text-xl text-gray-800 mb-3">Mago</p>
                                        <div
                                            class="text-sm text-gray-600 bg-indigo-100 rounded-full px-4 py-2 border border-indigo-200">
                                            Ingenioso • Estratega
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="glass-effect mb-8">
                    ...
                    <div class="description-content">
                        <p class="text-lg text-gray-700 leading-relaxed text-justify mb-6"
                            ...
                            El <strong class="text-indigo-600">Mago</strong> es el estratega del equipo. Con una gran
                            reserva de puntos de acción, puede lanzar habilidades potentes que alteran el curso de las
                            partidas. Su rol principal es recargar AP a los demás compañeros, permitiéndoles seguir
                            usando sus poderes. Además, puede manipular el tiempo, evitar penalizaciones y conceder
                            ventajas durante evaluaciones o tareas. Es perfecto para alumnos creativos, tácticos y
                            observadores que disfrutan ayudando desde las sombras.
                        </p>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-amber-800 font-medium text-lg">
                                        <strong>Ideal para:</strong> Alumnos creativos, tácticos y observadores que disfrutan
                                        ayudando desde las sombras.
                                    </p>
                                </div>
                            </div>
                        </div>
